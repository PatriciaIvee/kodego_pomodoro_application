...
import ph.kodego.leones.patricia.ivee.pomodoroapplication.MasterActivity
import ph.kodego.leones.patricia.ivee.pomodoroapplication.R
import ph.kodego.leones.patricia.ivee.pomodoroapplication.receiver.TimerNotificationActionReceiver
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .setContentIntent(getPendingIntentWithStack(context, MasterActivity::class.java))
